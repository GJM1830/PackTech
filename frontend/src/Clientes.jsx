// Pantalla de Clientes: alta rápida (RUC opcional + nombre), listado
// paginado con "cargar más", filtro local por texto y edición/eliminación
// mediante el menú de tres puntos (solo visible para vendedor o admin).
